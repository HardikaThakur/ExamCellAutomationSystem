        ...
        <ul>
            <li class="dropdown" onclick="toggleDisplay('2')">
                ...
                <div class="dropdown-content" id="2">
                    <a href="add_classes.php">Add Classes</a>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p1" id="" placeholder="Database Management System">
                <input type="text" name="p2" id="" placeholder="Computer Networks">
                <input type="text" name="p3" id="" placeholder="Web Development">
                <input type="text" name="p4" id="" placeholder="Theory Of Computation">
                <input type="text" name="p5" id="" placeholder="Advance Algorithm">
